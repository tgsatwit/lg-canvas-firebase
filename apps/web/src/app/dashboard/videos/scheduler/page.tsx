      ...
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200">
          <div className="px-6 py-4">
            <h1 className="text-2xl font-semibold text-gray-900">YouTube Scheduler</h1>
            <p className="text-gray-600 mt-1">Schedule your videos for automatic upload to YouTube</p>
          </div>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 p-4 border rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Scheduled for: Friday at 3:00 PM</p>
                    </div>
                    <Button size="sm" variant="outline">Edit</Button>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get notified about uploads</p>
                    </div>
                    <Button size="sm" variant="outline">
                      <Settings className="h-4 w-4 mr-2" />
                      Configure
